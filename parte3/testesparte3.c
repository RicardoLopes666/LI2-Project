...
int main()
{
    ...
    CU_ADD_TEST(suite, test_devolvePrimeiroNRiscado_tudo_riscado);
    CU_ADD_TEST(suite, test_devolvePrimeiroNRiscado_encontra);
    CU_ADD_TEST(suite, test_initVisited);
    CU_ADD_TEST(suite, test_queue_insert_delete);
    CU_ADD_TEST(suite, test_devolveNaoVisitados);
    CU_ADD_TEST(suite, test_existeCaminhoOrtogonal_simples);
    CU_ADD_TEST(suite, test_trataCaminhoOrtogonal_erro);
    CU_ADD_TEST(suite, test_trataCaminhoOrtogonal_ok);
    CU_basic_run_tests();
    CU_cleanup_registry();
    return 0;
}
