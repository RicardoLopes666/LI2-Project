...
int main()
{
    ...
    while (game.estado.looping)
    {
        ...
        printf("2)comando processado: %d , continuar:%d", comandoProcessado, continuar);
        ...
        printf("1)comando processado: %d , continuar:%d", comandoProcessado, continuar);
