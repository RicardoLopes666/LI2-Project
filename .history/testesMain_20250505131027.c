...
int main()
{
    ...
    CU_add_test(suite3, "Teste devolvePrimeroNRiscado", test_devolvePrimeroNRiscado);
    CU_add_test(suite3, "Teste initVisited", test_initVisited);
    CU_add_test(suite3, "Teste insertQueue", test_insertQueue);
    CU_add_test(suite3, "Teste deleteQueue", test_deleteQueue);
    CU_add_test(suite3, "Teste existeCaminhoOrtogonal", test_existeCaminhoOrtogonal);
