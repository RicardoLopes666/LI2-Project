...
void e(GAME g)
{
    ...
    printf("  Casas corretamente colocadas: %s (para mais informações use o comando 'c')", corretas);
    ...
    {
        printf("  Exsitem violações das regras encontradas encontradas (para mais informações utilize o comando 'v'\n");
    }
}