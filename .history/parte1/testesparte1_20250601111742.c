...
// -----------------------------------------------------------------------------
// test_colocaSolucao_nullResolve
// -----------------------------------------------------------------------------
void test_colocaSolucao_nullResolve()
{
    ...
    freeStackTabs(game.stackTabs);
    // freeTabela(old) não deve ser chamado porque resolve devolveu NULL
    freeTabela(old);
}

// -----------------------------------------------------------------------------
// test_colocaTabelaNaStack_fail
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Regista todas as suites e testes
// -----------------------------------------------------------------------------
int main()
{
    CU_initialize_registry();
    CU_pSuite suite = CU_add_suite("Parte1_Suite", NULL, NULL);

    CU_add_test(suite, "test_pintarBranco", test_pintarBranco);
    CU_add_test(suite, "test_riscar", test_riscar);
    CU_add_test(suite, "test_mostrarTabela", test_mostrarTabela);
    CU_add_test(suite, "test_coordenadaParaIndice", test_coordenadaParaIndice);
    CU_add_test(suite, "test_sair", test_sair);
    CU_add_test(suite, "test_gravar", test_gravar);
    CU_add_test(suite, "test_lerCmd_fileNotFound", test_lerCmd_fileNotFound);
    CU_add_test(suite, "test_lerCmd_freeOldTab", test_lerCmd_freeOldTab);
    CU_add_test(suite, "test_lerCmd_emptyFile", test_lerCmd_emptyFile);
    CU_add_test(suite, "test_lerCmd_incompleteData", test_lerCmd_incompleteData);
    CU_add_test(suite, "test_leTabuleiro_incomplete", test_leTabuleiro_incomplete);
    CU_add_test(suite, "test_colocaSolucao_nullResolve", test_colocaSolucao_nullResolve);
    CU_add_test(suite, "test_colocaTabelaNaStack_fail", test_colocaTabelaNaStack_fail);
    CU_add_test(suite, "test_i", test_i);
    CU_add_test(suite, "test_e_correctMatches", test_e_correctMatches);
    CU_add_test(suite, "test_e_violation", test_e_violation);
