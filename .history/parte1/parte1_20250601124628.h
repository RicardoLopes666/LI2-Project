...
void escreveEstatisticas(int percentagem, GAME g, int resolvidas, int total, int corretas, bool *comandoProcessado, int b, int r) void e(GAME g, bool *comandoProcessado);
