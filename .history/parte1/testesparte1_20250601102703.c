...
void test_lerCmd_freeOldTab(void)
{
    GAME game;
    ...
    // Como o único caractere é 'a', espera-se que resolve devolva 'A'
...
void test_lerCmd_emptyFile(void)
{
    GAME game;
...
void test_lerCmd_incompleteData(void)
{
    GAME game;
...
void test_colocaSolucao(void)
{
    ...
    // Chama colocaSolucao: temp ('n') deve ser freeTabela, e game.solution recebe solução de t1 ('A')
    colocaSolucao(&game);
...
void test_e(void)
{
    ...
    // Preenche t de forma que haja minúscula, riscada e incorreta
    ...
    t->tabela[1][1] = 'C'; // solução diferente
