...
{
    printf("%s> %s", COMMAND_COLOR, RESET);
...
int main()
{
    ...
    while (game.estado.looping)
    {
        ...
        printf("1)comando processado: %d , continuar:%d\n", comandoProcessado, continuar);
        ...
        printf("3)comando processado: %d , continuar:%d\n", comandoProcessado, continuar);
