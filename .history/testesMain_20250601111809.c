...
int main()
{
    ...
    CU_add_test(suite1, "test_leTabuleiro_incomplete", test_leTabuleiro_incomplete);
    CU_add_test(suite1, "test_colocaSolucao_nullResolve", test_colocaSolucao_nullResolve);
    CU_add_test(suite1, "test_colocaTabelaNaStack_fail", test_colocaTabelaNaStack_fail);
    CU_add_test(suite1, "test_i", test_i);
    CU_add_test(suite1, "test_e_correctMatches", test_e_correctMatches);
    CU_add_test(suite1, "test_e_violation", test_e_violation);
