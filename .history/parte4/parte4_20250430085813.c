...
void tentaRiscarLinhas(int c, int l1, int l2, TABELA *t, bool *continuar)
{
    ...
    for (int i = 0; keepGoing && i < 2; i++)
    {
        ...
        else if (verificaRestricoes(tentativa, false)) // TODO -> Analisar melhor como é que a solução esta a ser feita depois de aplicar o comando A pela primeira vez. Ver os memorie leaks.
        {
            keepGoing = 0;
            (*t)->tabela[linha][coluna] = '#';
