...
int main()
{
    ...
    CU_pSuite suite = CU_add_suite("Parte4_Tests", NULL, NULL);
    CU_add_test(suite, "test_verificaSeQuebraCaminho", test_verificaSeQuebraCaminho);
    CU_add_test(suite, "test_riscaLetrasRepetidas", test_riscaLetrasRepetidas);
    CU_add_test(suite, "test_pintaVizinhosDeRiscadas", test_pintaVizinhosDeRiscadas);
    CU_add_test(suite, "test_trataABA_linhas", test_trataABA_linhas);
    CU_add_test(suite, "test_trataABA_colunas", test_trataABA_colunas);
    CU_add_test(suite, "test_trataAA_A_NasLinhas", test_trataAA_A_NasLinhas);
    CU_add_test(suite, "test_trataAA_A_NasColunas", test_trataAA_A_NasColunas);
    CU_add_test(suite, "test_riscaABA", test_riscaABA);
    CU_add_test(suite, "test_existemMinusculas_and_jogoResolvido", test_existemMinusculas_and_jogoResolvido);
    CU_add_test(suite, "test_aplicaA", test_aplicaA);
    CU_add_test(suite, "test_comandoA", test_comandoA);
    CU_add_test(suite, "test_tentaRiscarColunas_resolve", test_tentaRiscarColunas_resolve);
    CU_add_test(suite, "test_tentaRiscarColunas_restricao", test_tentaRiscarColunas_restricao);
    CU_add_test(suite, "test_tentaColunas", test_tentaColunas);
    CU_add_test(suite, "test_tentaRiscarLinhas_resolve", test_tentaRiscarLinhas_resolve);
    CU_add_test(suite, "test_tentaRiscarLinhas_restricao", test_tentaRiscarLinhas_restricao);
    CU_add_test(suite, "test_tentaLinhas", test_tentaLinhas);
    CU_add_test(suite, "test_resolve_null", test_resolve_null);
    CU_add_test(suite, "test_resolve_success", test_resolve_success);
