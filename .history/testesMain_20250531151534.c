...
int main()
{
    ...
    CU_add_test(suite3, test_devolvePrimeiroNRiscado_tudo_riscado);
    CU_add_test(suite3, test_devolvePrimeiroNRiscado_encontra);
    CU_add_test(suite3, test_initVisited);
    CU_add_test(suite3, test_queue_insert_delete);
    CU_add_test(suite3, test_devolveNaoVisitados);
    CU_add_test(suite3, test_existeCaminhoOrtogonal_simples);
    CU_add_test(suite3, test_trataCaminhoOrtogonal_erro);
    CU_add_test(suite3, test_trataCaminhoOrtogonal_ok);
