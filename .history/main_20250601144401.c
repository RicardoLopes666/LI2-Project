...
void trataComandoQAlteraTab(cmd[0], arg, &continuar, &game, &comandoProcessado)
{
    if (cmd[0] == 'b' || cmd[0] == 'r')
    {
        ...
        trataComandoaARi(cmd[0], arg, &game, &continuar, &comandoProcessado); // Função que trata dos comando 'a', 'A', 'R' e 'i'
...
verificaExisteTab(GAME game, int *continuar, int comandoProcessado)
{
