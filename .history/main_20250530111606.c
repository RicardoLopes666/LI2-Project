...
void comandovduc(bool *continuar, char comando, GAME *game, bool *comandoProcessado)
{
    ...
    {
        printf(" %s  %s -> A peça esta colocada corretamente\n", CAPITAL_GREEN, RESET);
        printf(" %s  %s -> A peça esta erradamente colocada\n\n", CAPITAL_RED, RESET);
...
int main()
{
    ...
    while (game.estado.looping)
    {
        ...
        comandovduc(&continuar, cmd[0], &game, &comandoProcessado);
    }
